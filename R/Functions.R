...
plot_trace_strategy <- function(l_m_M) {
  ...
  m_M_plot <- m_M_plot%>% mutate(Strategy  = ifelse(Strategy == 1, v_names_str[1], 
                                                    ifelse(Strategy == 2, v_names_str[2], 
                                                           ifelse(Strategy == 3, v_names_str[3],
                                                                  v_names_str[4]))))
