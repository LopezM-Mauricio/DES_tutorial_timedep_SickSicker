...
Purpose:
- Lightweight, minimal implementations of DES of the Sick Sicker model in continuous time. 
- Modules keep dependencies small and code minimal; useful for small-scale runs or for fast prototyping.
