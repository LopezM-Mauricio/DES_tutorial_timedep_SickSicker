...
# ## Plot Epi Outcomes -----
#* Function `plot_epi_outcomes_DES` takes a list of data tables with Epi Outcomes
#* from each strategy and generates Prevalence, Survival, and Dwell times plots.
#
v_names_sick_states  <- c("S1", "S2")
v_names_strategies   <- c("SoC","A","B","AB")

l_plots_epi_outcomes <- plot_epi_outcomes_DES(l_epi_results = epi_fn(l_event_history_strategies = l_event_history_strategies))
Epi_Outcomes_plots   <- l_plots_epi_outcomes$p_all_epi
Epi_Outcomes_plots
#------------------------------------------------------------------------------#
#------------------------------------------------------------------------------#
